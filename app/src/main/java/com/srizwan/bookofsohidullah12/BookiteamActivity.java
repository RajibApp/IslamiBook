package com.srizwan.bookofsohidullah12;
...
public class BookiteamActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
        ...
        _setToolbarTitleMarquee(_toolbar);
	...
	private void _setToolbarTitleMarquee(Toolbar toolbar) {
    View view = toolbar.getChildAt(0);
    if (view instanceof TextView) {
        TextView titleTextView = (TextView) view;
        titleTextView.setEllipsize(TextUtils.TruncateAt.MARQUEE);
        titleTextView.setHorizontallyScrolling(true);
        titleTextView.setMarqueeRepeatLimit(-1); // -1 মানে সবসময় চলতে থাকবে
